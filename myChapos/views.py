...
def appoint(request):
    if request.method == 'POST':
        ...
        myappointment.save()
        messages.success(request, 'Imethibitishwa. Umebook Dkt wako. Subiri kujulishwa.')
...
def delete(request, id):
    ...
    myappoint.delete()
    messages.success(request, 'appointment yako imeenda!')
...
def edit(request, id):
    ...
    if request.method == 'POST':
        ...
        messages.success(request, 'umechange iyo samo vismooth')
        return render(request, 'edit.html')
    else:
        return render(request, 'edit.html', context={'editappointment': editappointment})
